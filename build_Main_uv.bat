...
uv run nuitka --standalone --enable-plugin=tk-inter ./GUI_Main.py --output-dir=./dist --output-filename=SCUFFLE --remove-output --windows-console-mode=disable --windows-icon-from-ico=.\Data\icon.ico --product-name=SCUFFLE --file-version=%1 --product-version=%1 --include-data-dir=./Config=Config --include-raw-dir=./Data=Data
move "./dist/GUI_Main.dist" "./dist/SCUFFLE"
rmdir /S /Q "./dist/SCUFFLE/Data/Custom/"

uv run nuitka --standalone --enable-plugin=tk-inter ./GUI_Moveviewer.py --output-dir=./dist --output-filename=SCUFFLE_Editor --remove-output --windows-console-mode=disable --windows-icon-from-ico=.\Data\icon.ico --product-name=SCUFFLE_Editor --file-version=%1 --product-version=%1 --include-data-dir=.\Config=.\Config --include-raw-dir=.\Data=.\Data 
move "./dist/GUI_Moveviewer.dist" "./dist/SCUFFLE_Editor"
rmdir /S /Q "./dist/SCUFFLE_Editor/Data/Custom/"
